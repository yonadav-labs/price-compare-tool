...
class Product(models.Model):
    ...
    appeagle_strategy = models.CharField('Appeagle Strategy', max_length=10, choices=STRATEGY_CHOICES, null=True, blank=True)
    ...
    prev_bb_price = models.FloatField('BB Price Previously', null=True, blank=True)
    run_at = models.ForeignKey(RunTime, verbose_name='Run Time', null=True, blank=True)
